package s3.algorithalliance.configuration.security.isauthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(s3.algorithalliance.configuration.security.isauthenticated.IsAuthenticated)")
    public void annotatedMethod() {
    }

    @Pointcut("@within(s3.algorithalliance.configuration.security.isauthenticated.IsAuthenticated)")
