...
VALUES 
    ...
    ('CPP-V3 issues not fixed', 2, "45.1.0.3", "2023-06-02 08:45:56"), 
...
VALUES 
    ...
    ('get_print_shouldReturnSecondsArray', 4), 
    ('addPrintJobToQueue_shouldReturnUpdatedList', 4), 

    ('get_print_shouldReturnSecondsArray', 5), 
    ('addPrintJobToQueue_shouldReturnUpdatedList', 5), 

    ('get_print_shouldReturnSecondsArray', 6), 
    ('addPrintJobToQueue_shouldReturnUpdatedList', 6), 

    ('killAllPrintJobs_shouldReturnEmptyList', 7), 
    ('getTimer_shouldReturnTimeList', 7), 
    ('skipToNextJob_shouldReturnNextJobObject', 8), 
    ('switchOff_ShouldReturnVoid', 9), 
    ('turnOn_ShouldReturnEmptyList', 9), 
    ('repeatJob_ShouldReturnPreviousJobObject', 9);
